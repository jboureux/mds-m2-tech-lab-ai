...
describe("API: GET /api/posts", () => {
	it("should return paginated posts", async () => {
		...
		// biome-ignore lint/suspicious/noExplicitAny: Mocking prisma return
	...
	it("should handle cursor pagination", async () => {
		const mockPosts = [{ id: "3", content: "Post 3", createdAt: new Date() }];
	...
	it("should return null nextCursor if fewer items than limit", async () => {
		const mockPosts = [{ id: "1", content: "Post 1", createdAt: new Date() }];
